...
// configuration step. It creates a namespace called `test_cmake`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", test_cmake::cmake::project_name, test_cmake::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", test_cmake::cmake::project_version);
      return EXIT_SUCCESS;
    }
